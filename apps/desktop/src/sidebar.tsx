...
import { ArchiveIcon, ChevronDownIcon, ExtensionIcon, FolderIcon, PinIcon, PlusIcon, RestoreIcon, SettingsIcon, SkillIcon, SparkIcon, WorktreeIcon } from "./icons";
    ...
    <aside className="sidebar">
      <div className="sidebar__top">
        ...
        <div className="sidebar__nav">
          ...
          <button
            className={`sidebar__nav-item ${activeView === "plan-control" ? "sidebar__nav-item--active" : ""}`}
            type="button"
            onClick={() => onSetActiveView("plan-control")}
          >
            <SparkIcon />
